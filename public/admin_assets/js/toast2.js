!function() {
    let e = document.querySelector(".toast-ex"), o = document.querySelector(".toast-placement-ex"), t = document.querySelector("#showToastAnimation"), s = document.querySelector("#showToastPlacement"), a, n, i, l, r;
    function c(t) {
    ...
    s && (s.onclick = function() {
        ...
        i = document.querySelector("#selectPlacement").value.split(" "),
        o.classList.add(a),
...
$(function() {
    ...
    $("#closeButton").on("click", function() {
        $(this).is(":checked") ? $("#addBehaviorOnToastCloseClick").prop("disabled", !1) : ($("#addBehaviorOnToastCloseClick").prop("disabled", !0),
    ...
    $("#showtoast").on("click", function() {
        ...
        m != toastr.options.positionClass && (toastr.options.hideDuration = 0,
        toastr.clear()),
        ...
        i.val().length && (toastr.options.timeOut = h ? 0 : parseInt(i.val())),
        l.val().length && (toastr.options.extendedTimeOut = h ? 0 : parseInt(l.val())),
        ...
        h && (e = (e = o) || "Clear itself?",
        o = e += '<br /><br /><button type="button" class="btn btn-secondary clear">Yes</button>',
