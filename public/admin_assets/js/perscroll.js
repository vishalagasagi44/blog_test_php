...
!function(t, e) {
    if ("object" == typeof exports && "object" == typeof module)
        ...
        var r = e();
        for (var i in r)
            ("object" == typeof exports ? exports : t)[i] = r[i]
    }
}(self, (function() {
    return function() {
        var t = {
                ...
                t.exports = function() {
                    ...
                    u.prototype.unbind = function(t, e) {
                        ...
                        this.handlers[t] = this.handlers[t].filter((function(i) {
                            return !(!e || i === e) || (r.element.removeEventListener(t, i, !1),
                            !1)
                        }
                        ))
                    }
                    ...
                    function b(t, e, r, i, n) {
                        ...
                        !function(t, e, r, i, n) {
                            ...
                            f[s] > t[l] - t[o] - 1 && (t.reach[a] = "end"),
                            e && (f.dispatchEvent(p("ps-scroll-" + a)),
                            e < 0 ? f.dispatchEvent(p("ps-scroll-" + u)) : e > 0 && f.dispatchEvent(p("ps-scroll-" + d)),
                            i && function(t, e) {
                                c(t, e),
                                h(t, e)
                            }(t, a)),
                            t.reach[a] && (e || n) && f.dispatchEvent(p("ps-" + a + "-reach-" + t.reach[a]))
                        }(t, r, l, i, n)
                    }
                    function g(t) {
                    ...
                    function m(t) {
                        ...
                        r.contains(t.scrollbarXRail) || (o(r, s.element.rail("x")).forEach((function(t) {
                            return l(t)
                        }
                        )),
                        r.appendChild(t.scrollbarXRail)),
                        r.contains(t.scrollbarYRail) || (o(r, s.element.rail("y")).forEach((function(t) {
                            return l(t)
                        }
                        )),
                        ...
                        t.scrollbarXWidth = Y(t, g(t.railXWidth * t.containerWidth / t.contentWidth)),
                        t.scrollbarXLeft = g((t.negativeScrollAdjustment + r.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth))) : t.scrollbarXActive = !1,
                        ...
                        t.scrollbarYHeight = Y(t, g(t.railYHeight * t.containerHeight / t.contentHeight)),
                        t.scrollbarYTop = g(i * (t.railYHeight - t.scrollbarYHeight) / (t.contentHeight - t.containerHeight))) : t.scrollbarYActive = !1,
                        ...
                        function(t, r) {
                            ...
                            r.isRtl ? i.left = r.negativeScrollAdjustment + t.scrollLeft + r.containerWidth - r.contentWidth : i.left = t.scrollLeft,
                            r.isScrollbarXUsingBottom ? i.bottom = r.scrollbarXBottom - n : i.top = r.scrollbarXTop + n,
                        ...
                        t.scrollbarXActive ? r.classList.add(s.state.active("x")) : (r.classList.remove(s.state.active("x")),
                        t.scrollbarXWidth = 0,
                        t.scrollbarXLeft = 0,
                        r.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0),
                        t.scrollbarYActive ? r.classList.add(s.state.active("y")) : (r.classList.remove(s.state.active("y")),
                    ...
                    function y(t, e) {
                        var r = e[0]
                          ...
                          , v = null;
                        function Y(e) {
                            e.touches && e.touches[0] && (e[n] = e.touches[0].pageY),
                            p[u] = b + v * (e[n] - g),
                            c(t, d),
                            m(t),
                            e.stopPropagation(),
                        ...
                        function w(e, o) {
                            b = p[u],
                            o && e.touches && (e[n] = e.touches[0].pageY),
                            g = e[n],
                            v = (t[i] - t[r]) / (t[l] - t[a]),
                            o ? t.event.bind(t.ownerDocument, "touchmove", Y) : (t.event.bind(t.ownerDocument, "mousemove", Y),
                    ...
                    var w = {
                            ...
                            t.event.bind(t.ownerDocument, "keydown", (function(r) {
                                if (!(r.isDefaultPrevented && r.isDefaultPrevented() || r.defaultPrevented) && (n(e, ":hover") || n(t.scrollbarX, ":focus") || n(t.scrollbarY, ":focus"))) {
                                    ...
                                    if (i) {
                                        ...
                                        if (n(s = i, "input,[contenteditable]") || n(s, "select,[contenteditable]") || n(s, "textarea,[contenteditable]") || n(s, "button,[contenteditable]"))
                                            return
                                    }
                                    var l = 0
                                      , o = 0;
                                    ...
                                    t.settings.suppressScrollX && 0 !== l || t.settings.suppressScrollY && 0 !== o || (e.scrollTop -= o,
                                    e.scrollLeft += l,
                                    m(t),
                                    function(r, i) {
                                        ...
                                        if (0 === r) {
                                            if (!t.scrollbarYActive)
                                                return !1;
                                            if (0 === n && i > 0 || n >= t.contentHeight - t.containerHeight && i < 0)
                                        ...
                                        if (0 === i) {
                                            if (!t.scrollbarXActive)
                                                return !1;
                                            if (0 === l && r < 0 || l >= t.contentWidth - t.containerWidth && r > 0)
                                                return !t.settings.wheelPropagation
                                        }
                                        return !0
                        ...
                        wheel: function(e) {
                            ...
                            function i(i) {
                                var n = function(t) {
                                  ...
                                  , o = n[1];
                                if (!function(e, i, n) {
                                    if (!v.isWebKit && r.querySelector("select:focus"))
                                        return !0;
                                    if (!r.contains(e))
                                        return !1;
                                    for (var l = e; l && l !== r; ) {
                                        if (l.classList.contains(s.element.consuming))
                                            return !0;
                                        var o = t(l);
                                        if (n && o.overflowY.match(/(scroll|auto)/)) {
                                            var a = l.scrollHeight - l.clientHeight;
                                            if (a > 0 && (l.scrollTop > 0 && n < 0 || l.scrollTop < a && n > 0))
                                                return !0
                                        }
                                        if (i && o.overflowX.match(/(scroll|auto)/)) {
                                            var c = l.scrollWidth - l.clientWidth;
                                            if (c > 0 && (l.scrollLeft > 0 && i < 0 || l.scrollLeft < c && i > 0))
                                                return !0
                                        }
                                        l = l.parentNode
                                    }
                                    ...
                                    var a = !1;
                                    e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (o ? r.scrollTop -= o * e.settings.wheelSpeed : r.scrollTop += l * e.settings.wheelSpeed,
                                    a = !0) : e.scrollbarXActive && !e.scrollbarYActive && (l ? r.scrollLeft += l * e.settings.wheelSpeed : r.scrollLeft -= o * e.settings.wheelSpeed,
                                    a = !0) : (r.scrollTop -= o * e.settings.wheelSpeed,
                                    r.scrollLeft += l * e.settings.wheelSpeed),
                                    m(e),
                                    (a = a || function(t, i) {
                                    ...
                                    }(l, o)) && !i.ctrlKey && (i.stopPropagation(),
                                    i.preventDefault())
                                }
                            }
                        ...
                        touch: function(e) {
                            if (v.supportsTouch || v.supportsIePointer) {
                                var r = e.element
                                  ...
                                  , l = {}
                                  , o = null;
                                v.supportsTouch ? (e.event.bind(r, "touchstart", u),
                                e.event.bind(r, "touchmove", d),
                                e.event.bind(r, "touchend", f)) : v.supportsIePointer && (window.PointerEvent ? (e.event.bind(r, "pointerdown", u),
                                e.event.bind(r, "pointermove", d),
                                e.event.bind(r, "pointerup", f)) : window.MSPointerEvent && (e.event.bind(r, "MSPointerDown", u),
                                    ...
                                    function(t, i) {
                                        ...
                                        if (s > o) {
                                            if (i < 0 && n === e.contentHeight - e.containerHeight || i > 0 && 0 === n)
                                                return 0 === window.scrollY && i > 0 && v.isChrome
                                        } else if (o > s && (t < 0 && l === e.contentWidth - e.containerWidth || t > 0 && 0 === l))
                                            return !0;
                                        return !0
                            ...
                            function f() {
                                e.settings.swipeEasing && (clearInterval(o),
                                o = setInterval((function() {
                                    e.isInitialized ? clearInterval(o) : l.x || l.y ? Math.abs(l.x) < .01 && Math.abs(l.y) < .01 ? clearInterval(o) : e.element ? (a(30 * l.x, 30 * l.y),
                                    l.x *= .8,
                                    l.y *= .8) : clearInterval(o) : clearInterval(o)
                                }
                                ), 10))
                            }
                        }
                      ...
                      , X = function(i, n) {
                        ...
                        this.isNegativeScroll = (a = i.scrollLeft,
                        null,
                        i.scrollLeft = -1,
                        c = i.scrollLeft < 0,
                        i.scrollLeft = a,
                        ...
                        this.scrollbarXTop = g(d.top)) : this.isScrollbarXUsingBottom = !0,
                        ...
                        this.scrollbarYLeft = g(p.left)) : this.isScrollbarYUsingRight = !0,
                        ...
                        this.railBorderYWidth = g(p.borderTopWidth) + g(p.borderBottomWidth),
        ...
        function r(i) {
            ...
            return t[i].call(l.exports, l, l.exports, r),
            l.exports
        }
        r.n = function(t) {
