!function(t, e) {
    ...
    return function() {
        ...
        return function() {
            ...
            var b, _ = ["rtl", "style", "headerType", "contentLayout", "layoutCollapsed", "showDropdownOnHover", "layoutNavbarOptions", "layoutFooterFixed", "themes"], x = ["light", "dark", "system"], S = ["sticky", "static", "hidden"], w = document.documentElement.classList;
            b = w.contains("layout-navbar-fixed") ? "sticky" : w.contains("layout-navbar-hidden") ? "hidden" : "static";
            var z = document.getElementsByTagName("HTML")[0].getAttribute("data-theme") || 0
              , k = w.contains("dark-style") ? "dark" : "light"
              , C = "rtl" === document.documentElement.getAttribute("dir")
              , T = !!w.contains("layout-menu-collapsed")
              , L = b
              , N = w.contains("layout-wide") ? "wide" : "compact"
              , A = !!w.contains("layout-footer-fixed")
              , O = w.contains("layout-menu-offcanvas") ? "static-offcanvas" : w.contains("layout-menu-fixed") ? "fixed" : w.contains("layout-menu-fixed-offcanvas") ? "fixed-offcanvas" : "static"
              , E = function() {
                function t(e) {
                    var i = e.cssPath
                      , s = e.themesPath
                    ...
                    !this._ssr) {
                        ...
                        this.settings.availableThemes = w || t.THEMES,
                        ...
                        this.settings.defaultTheme = this._getDefaultTheme(void 0 !== D ? D : z),
                        this.settings.styles = p || x,
                ...
                i = [{
                    ...
                    value: function() {
                        ...
                        this._hasControls("style") || (this.settings.style = w.contains("dark-style") ? "dark" : "light"),
                    ...
                    value: function() {
                        ...
                        if (this._hasControls("style")) {
                            this.settings.availableStyles.forEach((function(t) {
                                var e = i(t.name, t.title, "customRadioIcon", w.contains("dark-style"));
                                d.appendChild(e)
                            }
                            )),
                        ...
                        if (this._hasControls("rtl headerType contentLayout layoutCollapsed layoutNavbarOptions", !0)) {
                            ...
                            if (this._hasControls("rtl") && rtlSupport) {
                                ...
                                this.settings.availableDirections.forEach((function(t) {
                                    var e = i(t.name, t.title, "directionRadioIcon", w.contains("dark-style"));
                                    b.appendChild(e)
                                }
                                )),
                            ...
                            var x = this.container.querySelector(".template-customizer-headerOptions")
                              , S = document.documentElement.getAttribute("data-template").split("-");
                            if (this._hasControls("headerType")) {
                                var z = x.querySelector(".template-customizer-header-options");
                                setTimeout((function() {
                                    S.includes("vertical") && x.parentNode.removeChild(x)
                                }
                                ), 100),
                                this.settings.availableHeaderTypes.forEach((function(t) {
                                    var e = i(t.name, t.title, "headerRadioIcon", w.contains("dark-style"), "horizontal-".concat(t.name));
                                    z.appendChild(e)
                                }
                                )),
                                z.querySelector('input[value="'.concat(this.settings.headerType, '"]')).setAttribute("checked", "checked");
                                var k = function(e) {
                                    t.setLayoutType(e.target.value)
                                };
                                z.addEventListener("change", k),
                                this._listeners.push([z, "change", k])
                            } else
                            ...
                            if (this._hasControls("contentLayout")) {
                                ...
                                this.settings.availableContentLayouts.forEach((function(t) {
                                    var e = i(t.name, t.title, "contentRadioIcon", w.contains("dark-style"));
                                    T.appendChild(e)
                                }
                                )),
                            ...
                            if (this._hasControls("layoutCollapsed")) {
                                ...
                                this.settings.availableLayouts.forEach((function(t) {
                                    var e = i(t.name, t.title, "layoutsRadios", w.contains("dark-style"));
                                    A.appendChild(e)
                                }
                                )),
                            ...
                            if (this._hasControls("layoutNavbarOptions")) {
                                setTimeout((function() {
                                    S.includes("horizontal") && E.parentNode.removeChild(E)
                                }
                                ), 100);
                                var I = E.querySelector(".template-customizer-navbar-options");
                                this.settings.availableNavbarOptions.forEach((function(t) {
                                    var e = i(t.name, t.title, "navbarOptionRadios", w.contains("dark-style"));
                                    I.appendChild(e)
                                }
                                )),
